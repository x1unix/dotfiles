...
param system 'validate:desktop|mac|laptop' 'description:Target system type' required
...
HYPRLAND_PLATFORM_CFG="$XDG_CONFIG_HOME/hypr/platform-autogenerated.conf"
expand_template \
